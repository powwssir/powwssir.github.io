...
| 网站名称       | 网站地址                                                     | 备注                                                         |
| -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| google         | [Google](https://www.google.com.hk/)                         | 可以配合一些搜索技巧                                         |
| github         | [github](https://github.com/)                                | 开源项目、技术文章等                                         |
| stackoverflow  | [Stack Overflow - Where Developers Learn, Share, & Build Careers](https://stackoverflow.com/) | 技术论坛  技术问题答疑                                       |
| InfoQ          | [InfoQ - 促进软件开发及相关领域知识与创新的传播-极客邦](https://www.infoq.cn/) | 技术文章分享                                                 |
| 掘金           | [稀土掘金](https://juejin.cn/)                               | 技术文章分享                                                 |
| V2EX           | [V2EX](https://www.v2ex.com/)                                | 技术论坛                                                     |
| Medium         | [Medium – Where good ideas find you.](https://medium.com/)   | 技术文章分享                                                 |
| 微信公众号搜索 | [搜狗微信搜索_订阅号及文章内容独家收录，一搜即达](https://weixin.sogou.com/) 或者登陆微信搜索 | [洞见网安](https://wechat.doonsec.com/es/) 提供微信文章搜索  类似于官方的搜一搜 不过更聚焦于技术文章 ；如果想要查看公众号历史文章 可以使用爬虫工具获取 |
| SearXNG        | [SearXNG instances](https://searx.space/) 搜索引擎部署实例   | 开源元搜索引擎 支持私有部署                                  |
...
| Github     |                               |        | The GitHub Blog: Engineering News and Updates<br/>https://github.blog/category/engineering/ |
